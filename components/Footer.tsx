      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-10">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-gradient-to-r from-pink-500 via-purple-600 to-amber-500 text-white font-extrabold text-xs shadow-lg hover:scale-105 transition-transform"
            >
        ...
        <div className="pt-6 border-t border-border/40 flex flex-col md:flex-row items-center justify-between text-xs text-muted-foreground gap-2">
          ...
          <p className="flex items-center gap-1">
            Built with <Heart className="h-3.5 w-3.5 text-rose-500 fill-rose-500" /> for Indonesian Gamers
          </p>
        </div>
      </div>
    </footer>
